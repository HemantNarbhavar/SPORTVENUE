...
register_user :: Connection -> T.Users -> Servant.Handler Int
...
login_user :: Connection -> T.Login -> Servant.Handler Tx.Text
...
login_admin :: Connection -> T.Login -> Servant.Handler Tx.Text
